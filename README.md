...
A Python library for numerically solving mean field problems using the Deep BSDE method, focusing on McKean-Vlasov forward-backward stochastic differential equations (MV-FBSDEs) under common noise and mean field games.
