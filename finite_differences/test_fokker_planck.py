...
def test_calculate_divergence_term_one_dim_linear():
    output = one_dim_fokker_planck._calculate_divergence_term(np.ones_like(ONE_DIM_DOMAIN))
    np.testing.assert_array_almost_equal(output, np.ones_like(ONE_DIM_DOMAIN),decimal=2)
