...
# Filtration
FILTRATION = Filtration(spatial_dimensions=1, time_domain=torch.linspace(0,1,101), number_of_paths= 1)
...
def test_sample_paths():
    filtration = Filtration(spatial_dimensions=2, time_domain=torch.linspace(0,1,101), number_of_paths=10)
    filtration.generate_paths()
